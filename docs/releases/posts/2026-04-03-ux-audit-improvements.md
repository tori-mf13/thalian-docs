...
Comprehensive UX improvements across the Thalian landing page, demo experience, and signup flow based on a full product ecosystem audit.
...
- **Streamlined login** — email/password only with request access form for new visitors
